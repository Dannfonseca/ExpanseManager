 ...
 * - Movidos os seletores de Mês e Ano para o cabeçalho do card de "Resumo".
 * - A associação entre os seletores e os dados de resumo agora é visualmente clara.
 * - A lógica de filtragem permanece a mesma, atualizando tanto o resumo quanto a lista de transações.
 */
        ...
        <CardContent className="pt-6">
          ...
          <div className="mt-4 text-sm text-muted-foreground">
            <p>
              ...
              transações. Total da visualização:{" "}
